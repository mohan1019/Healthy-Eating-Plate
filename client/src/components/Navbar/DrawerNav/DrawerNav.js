...
import DehazeIcon from '@material-ui/icons/Dehaze.js';
...
import KitchenIcon from '@material-ui/icons/Kitchen.js';
import FastfoodIcon from '@material-ui/icons/Fastfood.js';
        ...
        <div>
            <Fragment key={'right'}>
                ...
                <Drawer anchor={'right'} open={state['right']} onClose={toggleDrawer('right', false)}>
                    {list('right')}
                    <footer className={classes.footer}>Copyright &copy; 2022 Batch 20</footer>
                </Drawer>
            </Fragment>
        </div>
    );
