...
import { Inject, ScheduleComponent, Day, Week, WorkWeek, Month, Agenda, EventSettingsModel } from '@syncfusion/ej2-react-schedule/index.js';
                            ...
                            <Grid container justify="center" alignItems="flex-start" spacing={10} style={{ marginBottom: 20 }}>
                                <Grid item xs={12} md={10}>
                                    <div style={{ display: 'flex', margin: '20px 0 0 0', justifyContent: 'space-between' }}>
                                        ...
                                        <div>
                                           <Button variant="outlined" onClick={handleDisplay}>Clear Your Schedule</Button>
                                        </div>
                                    </div>
                                </Grid>
                                {
